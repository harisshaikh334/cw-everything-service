...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_operators__ = __webpack_require__(237);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__picker_picker__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__location_select_location_select__ = __webpack_require__(260);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__add_product_add_product__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_detail_product_detail__ = __webpack_require__(263);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_camera__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tabs_tabs__ = __webpack_require__(72);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AddProductPage = /** @class */ (function () {
    ...
    AddProductPage.prototype.buildForm = function () {
        this.productForm = this.formBuilder.group({
            ...
            in_stock: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].pattern('^[0-9]*\.?[0-9]*$')])],
...
var OrderDetailsPage = /** @class */ (function () {
    function OrderDetailsPage(navCtrl, datePipe, toastSer, navParams, http, storage, alertCtrl) {
        this.navCtrl = navCtrl;
    ...
    OrderDetailsPage.prototype.loadOrderDetails = function () {
        ...
        this.http.get(__WEBPACK_IMPORTED_MODULE_4__app_apiconfig__["a" /* APIURL */] + 'orders/' + order.id + '?access-token=' + this.user.token)
            ...
            next: function (data) {
                ...
                _this.orderStatus = _this.order_details.status;
                if (_this.orderStatus == "Pending") {
                    _this.updateName = "Confirm Order";
                }
                else if (_this.orderStatus == "Confirmed") {
                    _this.updateName = "Delivered Order";
                }
    ...
    OrderDetailsPage.prototype.updateOrder = function () {
        var _this = this;
        ...
        var dataObj = {};
        var date = new Date();
        var d = this.datePipe.transform(date, 'yyyy-MM-dd HH:mm:ss');
        if (this.orderStatus == "Pending") {
        ...
        this.showLoader = true;
        this.http.put(__WEBPACK_IMPORTED_MODULE_4__app_apiconfig__["a" /* APIURL */] + "orders/" + this.order_details.id + "?access-token=" + this.user.token, dataObj)
            .subscribe({
            next: function (response) {
                _this.showLoader = false;
                ...
                toast.present();
                if (_this.orderStatus == "Pending") {
                    _this.orderStatus = "Confirmed";
                    _this.updateName = "Complete Order";
                }
                else if (_this.orderStatus == "Confirmed") {
                    // this.updateName = "Delivered Order";
                    _this.orderStatus = "Complete";
                }
            }, error: function (err) {
                _this.showLoader = false;
    ...
    OrderDetailsPage.prototype.handleAlert = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Update Order',
    ...
    OrderDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-order-details',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\order-details\order-details.html"*/'<!--\n  Generated template for the OrderDetailsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header class="bg-color">\n  <ion-navbar>\n    <ion-title>Order Details</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="bg-color">\n  <div *ngIf="showLoader" class="loader-bg">\n    <ion-spinner class="spinner" color="light"></ion-spinner>\n  </div>\n  <div class="total-price">\n    <h1>Total Price: &#8377; {{order_details?.sub_total}} </h1>\n    <p>Status : {{orderStatus}}</p>\n    <p>{{order_details?.subcategory?.name}}</p>\n    <p>Customer : {{order_details?.customer?.name}}</p>\n    <p>Address {{order_details.service_address}}</p>\n    <!-- <p>Address {{order.service_address}}</p> -->\n  </div>\n  <ion-list no-lines>\n    <ion-item *ngFor="let data of order_details?.product">\n      <div class="img_box center_img" item-start>\n        <img src="{{\'assets/imgs/avatar.png\'}}" width="100px" height="100px">\n    </div>\n    <h2 class="d-flex"><span>{{data.product_name }}</span>\n    </h2>\n    <!-- <h3>Plumber</h3> -->\n    <h3 class="d-flex">Sale Price {{data.sale_price}}</h3>\n    <h3 class="d-flex">MRP Price {{data.mrp}}</h3>\n    <h3 class="d-flex">Qty {{data.qty}}</h3>\n    <!-- <button ion-button (click)="openDesc(data)" class="d-flex">Show Description</button> -->\n    </ion-item>\n  </ion-list>\n</ion-content>\n<ion-footer no-border>\n  <button [hidden]="orderStatus == \'Complete\' || orderStatus == \'Cancelled\'" ion-button block (click)="handleAlert()" class="btn"> {{updateName | translate}}</button>\n</ion-footer>\n<div *ngIf="showDesc" class="modal-pop">\n  <div class="modal-inner">\n      <div class="modal-header">\n          <!-- <h2>{{popHeading}}</h2> -->\n          <button class="close-btn" (click)="closeDesc()"> &#10006;</button>\n      </div>\n      <div class="modal-body">\n          <p [innerHTML]="description">\n          </p>\n          <!-- <img [src]="popup_image" [title]="popHeading" [alt]="popHeading" /> -->\n      </div>\n  </div>\n</div>\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\order-details\order-details.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__angular_common__["d" /* DatePipe */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_common__["d" /* DatePipe */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["n" /* ToastController */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* NavParams */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["b" /* AlertController */]) === "function" && _g || Object])
    ], OrderDetailsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_operators__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_operators___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_apiconfig__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__picker_picker__ = __webpack_require__(134);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_apiconfig__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_background_geolocation__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_location_accuracy__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_diagnostic__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__appointment_status_appointment_status__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__my_profile_my_profile__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__popover_popover__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__product_list_product_list__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__order_details_order_details__ = __webpack_require__(141);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppointmentsPage = /** @class */ (function () {
    ...
    AppointmentsPage.prototype.loadAppointments = function () {
        var _this = this;
        this.showLoader = true;
        this.http.get(__WEBPACK_IMPORTED_MODULE_4__app_apiconfig__["a" /* APIURL */] + 'orders?access-token=' + this.user.token + '&where[sp_id]=' + this.user.id + "&where[is_product]=0")
            .subscribe({
            next: function (data) {
                _this.showLoader = false;
    ...
    AppointmentsPage.prototype.loadOrders = function () {
        var _this = this;
        this.showLoader = true;
    ...
    AppointmentsPage.prototype.order_details = function (item) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_12__order_details_order_details__["a" /* OrderDetailsPage */], { order: item });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_location_accuracy__ = __webpack_require__(136);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__add_product_add_product__ = __webpack_require__(140);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_apiconfig__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__all_reviews_all_reviews__ = __webpack_require__(266);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var All_reviewsPage = /** @class */ (function () {
    ...
    All_reviewsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-all_reviews',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\all_reviews\all_reviews.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{\'all_reviews\' | translate}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="bg-color">\n\n    <div *ngIf="showLoader" class="loader-bg">\n\n        <ion-spinner class="spinner" color="light"></ion-spinner>\n\n    </div>\n\n    <ion-list no-lines>\n\n        <ion-item *ngFor="let item of data.reviews">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="{{item.customer.profilepic}}" class="crop_img">\n\n            </div>\n\n            <h2 class="d-flex"><span>{{item.customer.name}}</span>\n\n                <ion-badge class="end">{{item.rating}} <ion-icon class="material-icons">star</ion-icon>\n\n                </ion-badge>\n\n            </h2>\n\n            <h3>{{item.subcategory}} | {{item.created_at}}</h3>\n\n            <p>{{item.comment}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\all_reviews\all_reviews.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_apiconfig__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_background_geolocation__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__my_profile_my_profile__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__contact_contact__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__about_about__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__faq_faq__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__change_password_change_password__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__signin_signin__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__product_list_product_list__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__order_hostory_order_hostory__ = __webpack_require__(272);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountPage = /** @class */ (function () {
    ...
    AccountPage.prototype.my_order_history = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_13__order_hostory_order_hostory__["a" /* OrderHostoryPage */]);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__order_details_order_details__ = __webpack_require__(141);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrderHostoryPage = /** @class */ (function () {
    ...
    OrderHostoryPage.prototype.order_details = function (item) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__order_details_order_details__["a" /* OrderDetailsPage */], { order: item });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", Object)
    ], OrderHostoryPage.prototype, "order_list", void 0);
    OrderHostoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-order-hostory',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\order-hostory\order-hostory.html"*/'<!--\n  Generated template for the OrderHostoryPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n\n\n\n  <ion-list no-lines>\n    <ion-item *ngFor="let item of order_list" (click)="order_details(item)">\n      <!-- <h2 class="d-flex"><span>{{\'Order Id: 1234567890\' }}</span>\n      </h2> -->\n      <h2 class="d-flex">Order ID : {{item?.order_id}}</h2>\n      <h2 class="d-flex">Status : {{item?.status}}</h2>\n      <h3 class="d-flex">Price {{item?.grand_total}}</h3>\n      <h3 class="d-flex">Order Date {{item?.created_at}}</h3>\n    </ion-item>\n    <div *ngIf="order_list.length == 0" class="emptydata" align="center">\n      <ion-icon name="close-circle" class="icon-md-primary" style="zoom:8.0;"></ion-icon>\n      <h4>No data found.</h4>\n  </div>\n  </ion-list>\n\n  \n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\order-hostory\order-hostory.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* PopoverController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Platform */], __WEBPACK_IMPORTED_MODULE_3__ionic_storage__["b" /* Storage */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
    ], OrderHostoryPage);
...
var ForgotPage = /** @class */ (function () {
    ...
    ForgotPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-forgot',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\forgot\forgot.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title></ion-title>\n\n    </ion-navbar>\n\n    <div class="text_box">\n\n        <h2>{{\'forgot_password\' | translate}}</h2>\n\n        <h3>{{\'forgot_text_1\' | translate}}<br>{{\'forgot_text_2\' | translate}}</h3>\n\n    </div>\n\n</ion-header>\n\n\n\n<ion-content class="bg-img">\n\n    <div *ngIf="showLoader" class="loader-bg">\n\n        <ion-spinner class="spinner" color="light"></ion-spinner>\n\n    </div>\n\n    <div class="form">\n\n        <ion-list no-lines>\n\n            <ion-item>\n\n                <ion-icon class="material-icons" item-start>phone</ion-icon>\n\n                <ion-label floating>{{\'mobile_number\' | translate}}</ion-label>\n\n                <ion-input type="text" maxlength="10" [(ngModel)]="mobile"></ion-input>\n\n            </ion-item>\n\n        </ion-list>\n\n        <button ion-button block class="btn" (click)="sendEmail()"> {{\'Continue\' | translate}}</button>\n\n    </div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\forgot\forgot.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_common_http__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ngx_translate_core__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ngx_translate_http_loader__ = __webpack_require__(433);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_camera__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_geolocation__ = __webpack_require__(261);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_background_geolocation__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_location_accuracy__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_native_diagnostic__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ionic_gallery_modal__ = __webpack_require__(259);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_all_reviews_all_reviews__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_account_account__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_appointment_status_appointment_status__ = __webpack_require__(258);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_appointments_appointments__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_category_category__ = __webpack_require__(435);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_chats_chats__ = __webpack_require__(436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_contact_contact__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_conversation_conversation__ = __webpack_require__(276);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_faq_faq__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_forgot_forgot__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_languag_languag__ = __webpack_require__(437);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_my_profile_my_profile__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_notification_notification__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_purchase_plan_purchase_plan__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_ratings_ratings__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_signin_signin__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_signup_signup__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_subscription_subscription__ = __webpack_require__(438);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_tabs_tabs__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_picker_picker__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_location_select_location_select__ = __webpack_require__(260);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_earnings_earnings__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_change_password_change_password__ = __webpack_require__(271);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_popover_popover__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__ionic_native_status_bar__ = __webpack_require__(439);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__ionic_native_splash_screen__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__pages_add_product_add_product__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__pages_product_list_product_list__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_product_detail_product_detail__ = __webpack_require__(263);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_order_hostory_order_hostory__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__pages_order_details_order_details__ = __webpack_require__(141);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_45__pages_order_hostory_order_hostory__["a" /* OrderHostoryPage */],
                __WEBPACK_IMPORTED_MODULE_46__pages_order_details_order_details__["a" /* OrderDetailsPage */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_splash_screen__ = __webpack_require__(234);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_signin_signin__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_ngx_translate_core__ = __webpack_require__(275);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\app\app.html"*/'<ion-nav #myNav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\app\app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__conversation_conversation__ = __webpack_require__(276);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatsPage = /** @class */ (function () {
    ...
    ChatsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-chats',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\chats\chats.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{\'chats\' | translate}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="bg-color">\n\n    <ion-list no-lines>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n        <ion-item (click)="conversation()">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="assets/imgs/plumber_profile.png" class="crop_img">\n\n            </div>\n\n            <h2><span>George Smith</span></h2>\n\n            <h3 class="d-flex">Plumber <span class="end">11:48 am</span></h3>\n\n            <p class="d-flex">Yeah, We are thankfull to you.</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\chats\chats.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], ChatsPage);
    return ChatsPage;
...
var LanguagPage = /** @class */ (function () {
    ...
    LanguagPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-languag',template:/*ion-inline-start:"C:\Users\91720\Downloads\cw-everything-service\src\pages\languag\languag.html"*/'<!--\n\n<ion-header>\n\n    <ion-navbar>\n\n        <ion-title></ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n-->\n\n\n\n<ion-content class="bg-img">\n\n    <div class="logo_box">\n\n        <img src="assets/imgs/logo.png">\n\n    </div>\n\n</ion-content>\n\n<ion-footer no-border>\n\n    <p text-center>{{\'select_preffered_app_language\' | translate}}</p>\n\n    <ion-row>\n\n        <ion-col col-6>\n\n            <button ion-button block class="btn francaic" (click)="signin()"> {{\'francaic\' | translate}}</button>\n\n        </ion-col>\n\n        <ion-col col-6>\n\n            <button ion-button block class="btn" (click)="signin()"> {{\'english\' | translate}}</button>\n\n        </ion-col>\n\n    </ion-row>\n\n</ion-footer>\n\n'/*ion-inline-end:"C:\Users\91720\Downloads\cw-everything-service\src\pages\languag\languag.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]])
    ], LanguagPage);
    return LanguagPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__purchase_plan_purchase_plan__ = __webpack_require__(277);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_apiconfig__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__signup_signup__ = __webpack_require__(236);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tabs_tabs__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__forgot_forgot__ = __webpack_require__(274);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appointments_appointments__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__notification_notification__ = __webpack_require__(264);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ratings_ratings__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__account_account__ = __webpack_require__(267);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__earnings_earnings__ = __webpack_require__(273);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
