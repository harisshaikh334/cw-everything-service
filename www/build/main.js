...
var All_reviewsPage = /** @class */ (function () {
    ...
    All_reviewsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-all_reviews',template:/*ion-inline-start:"G:\cw-everything-service\src\pages\all_reviews\all_reviews.html"*/'<ion-header>\n\n    <ion-navbar>\n\n        <ion-title>{{\'all_reviews\' | translate}}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="bg-color">\n\n    <div *ngIf="showLoader" class="loader-bg">\n\n        <ion-spinner class="spinner" color="light"></ion-spinner>\n\n    </div>\n\n    <ion-list no-lines>\n\n        <ion-item *ngFor="let item of data.reviews">\n\n            <div class="img_box center_img" item-start>\n\n                <img src="{{item.customer.profilepic}}" class="crop_img">\n\n            </div>\n\n            <h2 class="d-flex"><span>{{item.customer.name}}</span>\n\n                <ion-badge class="end">{{item.rating}} <ion-icon class="material-icons">star</ion-icon>\n\n                </ion-badge>\n\n            </h2>\n\n            <h3>{{item.subcategory}} | {{item.created_at}}</h3>\n\n            <p>{{item.comment}}</p>\n\n        </ion-item>\n\n    </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"G:\cw-everything-service\src\pages\all_reviews\all_reviews.html"*/
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"G:\cw-everything-service\src\app\app.html"*/'<ion-nav #myNav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"G:\cw-everything-service\src\app\app.html"*/
        }),
